    ...
    content: (
      <div className="relative w-full h-full">
        ...
        >
          <Button
            variant="outline"
            className="absolute bottom-28 left-[51%] z-10 -translate-x-1/2 rounded-none border border-gray-400 bg-white px-8 py-3 font-sora text-xs text-gray-700 hover:bg-gray-100"
          >
            visiter le site
          </Button>
        </Link>
