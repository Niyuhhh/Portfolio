    ...
    content: (
      <div className="relative w-full h-full">
        ...
        <video
          ...
          muted
          playsInline
          aria-label="Animation de démonstration"
        >
          <source
            src="https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExZDN6ZXp1OXZtaW5sMXg1eTRzMXdkc242NHVobmh6Z2ljNmtkdjJkYyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/L6J78MhsbfUmPdRl3N/giphy.mp4"
            type="video/mp4"
          />
          <img
